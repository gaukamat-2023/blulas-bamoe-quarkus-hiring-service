...
This module contains an example `Kogito Stateful Process (BPMN) Service`, using using Kogito, BPMN, DMN, packaged as a micro-service JAR, and using the `IBM BAMOE Quarkus runtime`.
